...
function About() {
    return (
        <div className="h-screen bg-gray-200  dark:bg-gray-600">
            <div className="p-8">
            ...
            <div className="h-screen bg-gray-200  dark:bg-gray-600  rounded-md mt-0 flex flex-wrap items-center  justify-center mb-8  ">
