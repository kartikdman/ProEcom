            ...
            <section className="text-gray-200 bg-gray-900">
                <div className="max-w-6xl mx-auto px-5 py-24 ">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">There Are Some Skills And Languages That I am Expert In👨‍💼 </p>
                            ...
                            <div className="pattern-dots-md gray-light">
                                <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6  "  >
                                    ...
                                    <div className="flex-grow ">
                                        ...
                                        <p className="leading-relaxed text-sm text-justify">I'm Very Familiar With HTML5 And Lot Of Experiece of using it.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="pattern-dots-md gray-light">
                                <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        I'm Very Familiar With CSS And Lot Of Experiece of using it.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="pattern-dots-md gray-light">
                                <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <p className="leading-relaxed text-sm text-justify">
                                        I'm Very Familiar With JavaScript And Lot Of Experiece of using it.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                            <div className="pattern-dots-md gray-light">
                                <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                                    ...
                                    <div className="flex-grow">
                                        <h2 className=" text-xl title-font font-medium mb-3">React.JS</h2>
                                        <p className="leading-relaxed text-sm text-justify">
                                        I'm Very Familiar With React.JS And Lot Of Experiece of using it.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                            <div className="pattern-dots-md gray-light">
                                <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                                    ...
                                    <div className="flex-grow">
                                        <h2 className=" text-xl title-font font-medium mb-3">Tailwind CSS</h2>
                                        <p className="leading-relaxed text-sm text-justify">
                                        I'm Very Familiar With TailWind CSS And Lot Of Experiece of using it.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                            <div className="pattern-dots-md gray-light">
                                <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                                    ...
                                    <div className="flex-grow">
                                        <h2 className=" text-xl title-font font-medium mb-3">Git/GitHub</h2>
                                        <p className="leading-relaxed text-sm text-justify">
                                        I'm Very Familiar With Git/GitHub And Lot Of Experiece of using it.
                                        </p>
                                    </div>
                                </div>
                            </div>
